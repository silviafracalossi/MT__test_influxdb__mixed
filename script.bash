...
#
# == Executing N Ingestion ([M] [N] [l/s] [table_name] [file_name_in_data_folder]) #TEMPERATURE_nodup.csv
echo "Executing NDataIngestionTest.jar..."
java -jar standalone/NDataIngestionTest.jar 200 200 $1 $2 TEMPERATURE_HalfGB_ns.csv > "logs/${folder}/extra/out__N_ingestion.txt"
rm -r logs/2020*_200
echo "Ingestion completed!"
echo ""
#
# == Executing Ingestion Part ([l/s] [dbName] [data_file_name] [log_folder] [inmem/tsi]) #TEMPERATURE_nodup.csv
echo "Executing IngestionMixed.jar ..."
nohup java -jar standalone/IngestionMixed.jar $1 $2 TEMPERATURE_1GB_ns.csv $folder $3 > "logs/${folder}/extra/out__ingestion.txt" 2> "logs/${folder}/extra/err__ingestion.txt" &
#
